...
if __name__ == "__main__":
    ...
    model.fit_generator(train_generator, steps_per_epoch = train_generator.samples // BATCH_SIZE, validation_data = valid_generator, validation_steps = validation_generator.samples // BATCH_SIZE, epochs = nb_epochs, callbacks=[checkpoint])